...
sidebar:
  label: "09: OOP: Inheritance, Abstract Classes, and Interfaces"
  order: 9
  badge:
    text: Intermediate
    variant: caution
...
**Code**: [View complete example](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/09-inheritance/09-oop-demo.php)
...
**Code**: [View complete example](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/09-inheritance/09-inheritance.php)
...
**Code**: [View complete example](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/09-inheritance/09-method-overriding.php)
...
**Code**: [View complete example](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/09-inheritance/09-abstract-shapes.php)
...
**Code**: [View complete example](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/09-inheritance/09-interfaces.php)
...
**Code**: [View complete example](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/09-inheritance/09-multiple-interfaces.php)
