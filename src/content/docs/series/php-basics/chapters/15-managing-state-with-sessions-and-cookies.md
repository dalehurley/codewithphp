...
sidebar:
  label: "15: Managing State with Sessions and Cookies"
  order: 15
  badge:
    text: Intermediate
    variant: caution
...
- [`session-basics.php`](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/15-sessions/session-basics.php) - Session fundamentals and basic usage
- [`cookie-basics.php`](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/15-sessions/cookie-basics.php) - Working with cookies
- [`auth-system.php`](https://github.com/dalehurley/codewithphp/blob/main/code/php-basics/15-sessions/auth-system.php) - Complete authentication system with sessions
