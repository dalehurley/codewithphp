...
<ProgressTracker
  :items="[
    { title: 'RESTful API', description: 'Building REST APIs in PHP vs Spring Boot', chapter: 3 },
    { title: 'Data Access Layer', description: 'Working with databases using PDO vs JDBC', chapter: 5 },
    { title: 'Dependency Injection', description: 'DI containers in PHP vs Java', chapter: 7 },
    { title: 'Authentication System', description: 'JWT authentication in PHP', chapter: 9 },
    { title: 'Testing Suite', description: 'PHPUnit vs JUnit testing patterns', chapter: 11 },
    { title: 'Full MVC Application', description: 'Building a complete web app', chapter: 14 }
  ]"
/>
