---
title: "15: Building Vector Databases"
...
difficulty: "Advanced"
prerequisites:
  - "/series/openai-php/chapters/14-*"
---

![Building Vector Databases](/images/openai-php/chapter-15-building-vector-databases-hero-full.webp)

[Home](/series/openai-php) > Building Vector Databases
...
Set up and optimize vector databases (Pinecone, Redis, Qdrant) for scalable semantic search
...
👉 **[Chapter 16: Next Topic](/series/openai-php/chapters/16-*)**
...
```
/code-samples/openai-php/chapter-15/
```

---

[← Previous: Chapter 14](/series/openai-php/chapters/14-*) | [Next: Chapter 16 →](/series/openai-php/chapters/16-*)
