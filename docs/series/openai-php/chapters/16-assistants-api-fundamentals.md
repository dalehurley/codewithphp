---
title: "16: Assistants API Fundamentals"
...
difficulty: "Advanced"
prerequisites:
  - "/series/openai-php/chapters/15-*"
---

![Assistants API Fundamentals](/images/openai-php/chapter-16-assistants-api-fundamentals-hero-full.webp)

[Home](/series/openai-php) > Assistants API Fundamentals

# Chapter 16: Assistants API Fundamentals

<span class="difficulty-badge difficulty-advanced">Advanced</span>
<span class="time-badge">80-95 min</span>


## Overview

Build stateful AI assistants with persistent threads and integrated tools using the Assistants API
...
👉 **[Chapter 17: Next Topic](/series/openai-php/chapters/17-*)**
...
```
/code-samples/openai-php/chapter-16/
```

---

[← Previous: Chapter 15](/series/openai-php/chapters/15-*) | [Next: Chapter 17 →](/series/openai-php/chapters/17-*)
