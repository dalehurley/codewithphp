---
title: "11: JSON Mode & Structured Outputs"
...
prerequisites:
  - "/series/openai-php/chapters/10-*"
---

![JSON Mode & Structured Outputs](/images/openai-php/chapter-11-json-mode-structured-outputs-hero-full.webp)

[Home](/series/openai-php) > JSON Mode & Structured Outputs

# Chapter 11: JSON Mode & Structured Outputs

<span class="difficulty-badge difficulty-intermediate">Intermediate</span>
<span class="time-badge">60-70 min</span>


## Overview

Extract structured data reliably using JSON mode and schema validation for consistent application integration
...
👉 **[Chapter 12: Next Topic](/series/openai-php/chapters/12-*)**
...
```
/code-samples/openai-php/chapter-11/
```

---

[← Previous: Chapter 10](/series/openai-php/chapters/10-*) | [Next: Chapter 12 →](/series/openai-php/chapters/12-*)
