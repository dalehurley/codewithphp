---
title: "18: Assistants Tools: File Search"
...
difficulty: "Advanced"
prerequisites:
  - "/series/openai-php/chapters/17-*"
---

![Assistants Tools: File Search](/images/openai-php/chapter-18-assistants-file-search-hero-full.webp)

[Home](/series/openai-php) > Assistants Tools: File Search
...
Implement retrieval-augmented generation (RAG) using the Assistants API File Search tool
...
👉 **[Chapter 19: Next Topic](/series/openai-php/chapters/19-*)**
...
```
/code-samples/openai-php/chapter-18/
```

---

[← Previous: Chapter 17](/series/openai-php/chapters/17-*) | [Next: Chapter 19 →](/series/openai-php/chapters/19-*)
