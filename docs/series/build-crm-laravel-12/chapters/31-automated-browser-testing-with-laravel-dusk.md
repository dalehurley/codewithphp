...
description: "Writing end-to-end tests for the CRM using Laravel Dusk. Discuss why automated UI testing is valuable for a large application (to catch regressions in..."
...
- Completed [Chapter 30](/series/build-crm-laravel-12/chapters/30-previous-chapter)
