...
description: "Adding full-text search capabilities to the CRM using Laravel Scout. Discuss the need for search (e.g., quickly finding contacts or deals by name). Ex..."
...
- Completed [Chapter 24](/series/build-crm-laravel-12/chapters/24-previous-chapter)
