---
title: "21: API Authentication with Sanctum"
description: "Protecting the API and authenticating requests using Laravel Sanctum. Explain the difference between session authentication vs. token auth. Introduce ..."
...
Protecting the API and authenticating requests using Laravel Sanctum. Explain the difference between session authentication vs. token auth. Introduce Sanctum's personal access tokens which are perfect for first-party SPAs or mobile apps. Walk through configuring Sanctum (ensuring the sanctum middleware is applied) and how clients can obtain and use API tokens.
...
- Completed [Chapter 20](/series/build-crm-laravel-12/chapters/20-previous-chapter)
...
- Understanding of api authentication with sanctum
...
Congratulations! You've completed this chapter on api authentication with sanctum.
...
<ChapterCheckbox 
  ...
  chapterId="21"
  label="Completed: 21: API Authentication with Sanctum"
/>
