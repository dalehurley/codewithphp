---
title: "22: OAuth2 with Laravel Passport"
description: "When to use Passport – providing a full OAuth2 server for third-party clients. Discuss the need for Passport in scenarios where external applications ..."
...
When to use Passport – providing a full OAuth2 server for third-party clients. Discuss the need for Passport in scenarios where external applications should integrate with the CRM. Outline OAuth2 concepts (clients, authorization codes, scopes).
...
- Completed [Chapter 21](/series/build-crm-laravel-12/chapters/21-previous-chapter)
...
- Understanding of oauth2 with laravel passport
...
Congratulations! You've completed this chapter on oauth2 with laravel passport.
...
<ChapterCheckbox 
  ...
  chapterId="22"
  label="Completed: 22: OAuth2 with Laravel Passport"
/>
