---
title: "30: Monitoring Queues with Laravel Horizon"
description: "Using Laravel Horizon to manage and monitor queue workers via a beautiful dashboard. Explain Horizon's benefits: code-driven configuration of supervis..."
...
Using Laravel Horizon to manage and monitor queue workers via a beautiful dashboard. Explain Horizon's benefits: code-driven configuration of supervisors, real-time metrics on jobs processed, failures, etc., and controlling queues without diving into server consoles.
...
- Completed [Chapter 29](/series/build-crm-laravel-12/chapters/29-previous-chapter)
...
- Understanding of monitoring queues with laravel horizon
...
Congratulations! You've completed this chapter on monitoring queues with laravel horizon.
...
<ChapterCheckbox 
  ...
  chapterId="30"
  label="Completed: 30: Monitoring Queues with Laravel Horizon"
/>
