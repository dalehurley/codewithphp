---
title: "23: Social Logins with Laravel Socialite"
description: "Allowing users to log in or sign up via social networks (Google, Facebook, etc.) using Laravel Socialite. Explain OAuth social login flow: redirect to..."
...
Allowing users to log in or sign up via social networks (Google, Facebook, etc.) using Laravel Socialite. Explain OAuth social login flow: redirect to provider, callback, etc. Highlight which social providers are common for CRM users (Google for Gmail contacts sync, etc.).
...
- Completed [Chapter 22](/series/build-crm-laravel-12/chapters/22-previous-chapter)
...
Congratulations! You've completed this chapter on social logins with laravel socialite.
...
<ChapterCheckbox 
  ...
  chapterId="23"
  label="Completed: 23: Social Logins with Laravel Socialite"
/>
