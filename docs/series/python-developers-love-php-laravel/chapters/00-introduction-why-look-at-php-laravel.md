...
<Quiz
  title="Chapter 00 Quiz: Introduction to PHP and Laravel"
  :questions="[
    {
      question: 'Why do many Python developers have outdated perceptions of PHP?',
      options: [
        { text: 'PHP hasn\'t changed since 2010', correct: false, explanation: 'Actually, PHP has evolved dramatically since 2010. PHP 7.0 (2015) introduced type hints and performance improvements, and PHP 8.0+ added JIT compilation and modern features.' },
        { text: 'They haven\'t looked at PHP since PHP 5.x, which ended support in 2018', correct: true, explanation: 'Correct! Many developers formed their opinions about PHP based on PHP 5.x or earlier versions. Modern PHP (7.4+ and especially 8.0+) is fundamentally different.' },
        { text: 'PHP is only used for WordPress sites', correct: false, explanation: 'While WordPress uses PHP, many major companies (Facebook, Slack, Etsy, Wikipedia) use PHP for large-scale applications.' },
        { text: 'Python is inherently better than PHP', correct: false, explanation: 'Neither language is universally better. They excel in different areas: PHP/Laravel for web apps, Python for data science and ML.' }
      ]
    },
    {
      question: 'What makes Python developers well-suited to learn PHP/Laravel?',
      options: [
        { text: 'They already know PHP syntax', correct: false, explanation: 'No prior PHP knowledge is required. Python developers bring conceptual knowledge (MVC, ORMs, REST APIs) that translates directly.' },
        { text: 'The concepts they\'ve mastered (MVC, ORMs, REST APIs) are universal, not language-specific', correct: true, explanation: 'Correct! MVC is MVC whether it\'s Django or Laravel. ORMs work similarly. REST APIs follow the same principles. You\'re learning new syntax for familiar concepts.' },
        { text: 'Python and PHP have identical syntax', correct: false, explanation: 'The syntax is different (PHP uses $ for variables, semicolons), but the underlying concepts and patterns are the same.' },
        { text: 'They need to forget everything they know about Python', correct: false, explanation: 'Not at all! Your Python knowledge is an asset. This series helps you leverage your existing knowledge while learning new syntax.' }
      ]
    },
    {
      question: 'Which PHP version introduced JIT compilation and union types?',
      options: [
        { text: 'PHP 7.0', correct: false, explanation: 'PHP 7.0 introduced type hints, return types, and performance improvements, but not JIT compilation or union types.' },
        { text: 'PHP 8.0', correct: true, explanation: 'Correct! PHP 8.0 (2020) added JIT compilation, union types, named arguments, and match expressions.' },
        { text: 'PHP 8.4', correct: false, explanation: 'PHP 8.4 (2024) added property hooks and asymmetric visibility, but JIT and union types came in PHP 8.0.' },
        { text: 'PHP 5.x', correct: false, explanation: 'PHP 5.x didn\'t have these modern features. JIT compilation and union types are PHP 8.0+ features.' }
      ]
    },
    {
      question: 'When should Python developers consider using Laravel?',
      options: [
        { text: 'Never—Python is always better', correct: false, explanation: 'Neither language is universally better. Laravel excels at rapid web application development, while Python excels at data science and ML.' },
        { text: 'For rapid web application development, business applications, and content management', correct: true, explanation: 'Correct! Laravel is exceptional for rapid web application development, business applications, and content management. Python remains superior for data science, ML, and scientific computing.' },
        { text: 'Only if they want to abandon Python completely', correct: false, explanation: 'No! Many successful teams use both languages depending on the project. Laravel for web apps, Python for data/ML.' },
        { text: 'When they need better performance than Python', correct: false, explanation: 'While PHP 8+ with JIT is faster than Python for web apps, performance alone isn\'t the deciding factor. Consider the full value proposition.' }
      ]
    }
  ]"
/>
