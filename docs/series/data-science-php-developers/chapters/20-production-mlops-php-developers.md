...
difficulty: "Advanced"
prerequisites:
  - "/series/data-science-php-developers/chapters/19-big-data-dask-polars-distributed"
  - "Understanding of production deployment from Chapter 12"
keywords:
  [
    "MLOps tutorial",
...
teaches:
  [
    ...
    "Scalable model serving with Docker",
    "Monitoring performance and model drift",
    "A/B testing and Canary deployments",
    "Automated retraining pipelines from PHP",
  ]
...
<ChapterCheckbox 
  ...
  chapterId="20"
  label="You've mastered MLOps and completed the series!"
/>
