...
prerequisites:
  - "/series/data-science-php-developers/chapters/09-using-machine-learning-models-in-php-applications"
keywords:
  [
    "PHP data visualization",
    "Chart.js PHP",
    "PHP dashboards",
    "PDF reports PHP",
    "data reporting",
...
<ChapterCheckbox 
  ...
  chapterId="10"
  label="You can visualize and communicate data insights effectively!"
/>
