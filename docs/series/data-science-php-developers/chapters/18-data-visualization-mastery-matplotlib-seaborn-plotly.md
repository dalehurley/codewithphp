...
prerequisites:
  - "/series/data-science-php-developers/chapters/17-deep-learning-tensorflow-keras"
  - "Understanding of data visualization from Chapter 10"
keywords:
  [
...
teaches:
  [
    ...
    "Customizing plots professionally",
    "Exporting for web and PDF",
    "Embedding Python charts in PHP dashboards",
  ]
...
<ChapterCheckbox 
  ...
  chapterId="18"
  label="You've mastered advanced data visualization with Python!"
/>
