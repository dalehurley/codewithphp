...
prerequisites:
  - "/series/data-science-php-developers/chapters/05-exploratory-data-analysis-for-php-developers"
  - "Understanding of PHP generators and iterators"
keywords:
  [
    "PHP large datasets",
...
teaches:
  [
    "Streaming large files with generators",
    ...
    "Processing data without loading into memory",
  ]
...
<ChapterCheckbox 
  ...
  chapterId="06"
  label="You've mastered large dataset processing!"
/>
