...
difficulty: "Advanced"
prerequisites:
  - "/series/data-science-php-developers/chapters/18-data-visualization-mastery-matplotlib-seaborn-plotly"
  - "Understanding of large dataset handling from Chapter 6"
keywords:
  [
    "big data Python",
    "Dask tutorial",
...
teaches:
  [
    "Processing datasets too large for RAM",
    "Polars for blazing-fast multi-threaded DataFrames",
    "Dask for parallelizing pandas and NumPy",
    "Lazy evaluation vs. Eager execution",
    "Distributed computing clusters",
    "Orchestrating big data jobs from PHP",
  ]
...
<ChapterCheckbox 
  ...
  chapterId="19"
  label="You've mastered Big Data with Dask and Polars!"
/>
