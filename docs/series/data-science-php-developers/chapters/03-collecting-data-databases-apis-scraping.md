...
prerequisites:
  - "/series/data-science-php-developers/chapters/02-setting-up-data-science-environment"
  - "PHP 8.4+ with PDO, cURL extensions"
  - "Composer installed"
keywords:
  [
    "PHP data collection",
...
teaches:
  [
    "Database data extraction with PDO",
    "REST API consumption with Guzzle",
    "Ethical web scraping techniques",
    "Error handling and retry logic",
    "Rate limiting and authentication",
    "Data validation and transformation",
    "Building reusable data collectors",
  ]
...
<ChapterCheckbox 
  ...
  chapterId="03"
  label="You've mastered data collection in PHP!"
/>
