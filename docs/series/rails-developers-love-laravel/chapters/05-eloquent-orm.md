---
title: "Working with Data: Eloquent ORM & Database Workflow"
...
# Chapter 05: Working with Data: Eloquent ORM & Database Workflow <span class="difficulty-badge difficulty-intermediate">Intermediate</span>
...
Eloquent and ActiveRecord are remarkably similar:

✅ **Same Active Record pattern** — Models map to tables
✅ **Similar relationships** — `hasMany`, `belongsTo`, `belongsToMany`
✅ **Chainable queries** — Build queries fluently
✅ **Scopes** — Reusable query logic
✅ **Eager loading** — Prevent N+1 queries
✅ **Migrations** — Version control for database schema
✅ **Model events** — Like ActiveRecord callbacks
✅ **Soft deletes** — Built-in support

The main differences:
- PHP syntax instead of Ruby
- Explicit `->get()` to execute queries
- `$fillable` instead of strong parameters
- Convention: `camelCase` for methods, `snake_case` for database columns
