          ...
          { text: 'Overview', link: '/series/rails-developers-love-laravel/' },
          {
            ...
            items: [
              ...
              },
              {
                ...
                link: '/series/rails-developers-love-laravel/chapters/07-testing-deployment'
              },
              {
                text: '08 — Ecosystem, Community, Packages & Where Laravel Excels',
                link: '/series/rails-developers-love-laravel/chapters/08-ecosystem'
              },
              {
                text: '09 — When to Use Laravel (and When Rails Still Makes Sense)',
                link: '/series/rails-developers-love-laravel/chapters/09-when-to-use-laravel'
              },
              {
                text: '10 — Bonus: Hands-On Mini Project',
                link: '/series/rails-developers-love-laravel/chapters/10-hands-on-project'
              }
            ]
          }
        ],
